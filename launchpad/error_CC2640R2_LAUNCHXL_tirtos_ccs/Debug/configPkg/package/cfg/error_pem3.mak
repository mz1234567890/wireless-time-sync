...
package/cfg/error_pem3.oem3: export C_DIR=
package/cfg/error_pem3.oem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/:$(PATH)

package/cfg/error_pem3.sem3: | .interfaces
package/cfg/error_pem3.sem3: package/cfg/error_pem3.c package/cfg/error_pem3.mak
	@$(RM) $@.dep
	$(RM) $@
	@$(MSG) clem3 -n $< ...
...
package/cfg/error_pem3.sem3: export C_DIR=
package/cfg/error_pem3.sem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/:$(PATH)

clean,em3 ::
	-$(RM) package/cfg/error_pem3.oem3
	-$(RM) package/cfg/error_pem3.sem3

error.pem3: package/cfg/error_pem3.oem3 package/cfg/error_pem3.mak

clean::
	-$(RM) package/cfg/error_pem3.mak
